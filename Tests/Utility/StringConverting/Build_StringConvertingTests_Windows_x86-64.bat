...
cl.exe /c StringConvertingTests.cpp /Fo"StringConvertingTests.obj" /I"..\..\..\SrcCode" /W3 /Od /std:c++17 /MTd /DDEBUG /D_DEBUG

link.exe /DEBUG:FULL /MACHINE:X64 "*.obj" /OUT:"StringConvertingTestsExec.exe"
