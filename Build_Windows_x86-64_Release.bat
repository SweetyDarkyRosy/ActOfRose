...
for %%f in ("SrcCode\*.cpp") do (
    cl /c "%%f" /Fo"Bin\Intermediates\Win_x86-64\Release\%%~nf.obj" /Fd"Bin\Intermediates\Win_x86-64\Release\%%~nf.pdb" /W3 /O2 /std:c++17 /Zi /MT /DNDEBUG /D_NDEBUG
)
